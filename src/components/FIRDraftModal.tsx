        ...
        <div className="p-5 sm:p-7 overflow-y-auto bg-white print-content">
          ...
          >
            ...
            <div className="space-y-2 text-justify">
              ...
              <p>
                I bring to your attention that on {transaction.timestamp}, a cybercrime was committed involving {transaction.contentType.replace(/_/g, ' ')}.
              </p>
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <p className="mt-0.5 font-bold">SIGNATURE OF COMPLAINANT</p>
